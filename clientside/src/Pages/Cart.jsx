      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-teal-600">Shopping Cart</h1>
          </div>
        </div>
      </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              ...
              <div className="lg:col-span-2 space-y-3 sm:space-y-4">
                {cartItems.map((item) => (
                  <div key={item._id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4 hover:shadow-md transition-shadow">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0 text-center sm:text-left">
                        ...
                        <p className="text-gray-500 text-xs sm:text-sm mb-2">
                          Size: {item.productId?.size || 'NB'} • {item.productId?.count || '75pcs'}
                        </p>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 text-sm" disabled
                    />
                  </div>
